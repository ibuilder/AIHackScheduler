...
class CollaborationManager:
    ...
    def register_task_update(self, project_id, user_id, task_id, task_name, update_type="update"):
        ...
        self.register_user_activity(
            ...
            user_id,
            "task_update",
            {"task_id": task_id, "task_name": task_name, "update_type": update_type},
        )
        ...
        audit_logger.log_action(
            ...
            resource_type="task",
            resource_id=task_id,
            details={"project_id": project_id, "collaboration_tracked": True},
        )
...
def get_active_users(project_id):
    ...
    return jsonify(
        {"project_id": project_id, "active_users": active_users, "total_count": len(active_users)}
    )
...
def get_project_messages(project_id):
    ...
    return jsonify({"project_id": project_id, "messages": messages})
