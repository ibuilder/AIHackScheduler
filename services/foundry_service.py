...
class FoundryService:
    ...
    def _make_foundry_request(self, endpoint: str, data: dict) -> dict:
        ...
        try:
            ...
            raise RuntimeError(f"Foundry API request failed: {e}") from e
    ...
    def predict_project_outcomes(self, project_id: int, prediction_type: str) -> dict[str, Any]:
        ...
        project_features = {
            ...
            "location_complexity": len({t.location for t in tasks if t.location}),
    ...
    def _predict_completion_date(self, request_data: dict) -> dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Completion date prediction failed: {str(e)}"}
    ...
    def _predict_budget_variance(self, request_data: dict) -> dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Budget variance prediction failed: {str(e)}"}
    ...
    def _predict_resource_needs(self, request_data: dict) -> dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Resource prediction failed: {str(e)}"}
    ...
    def generate_schedule_insights(self, project_id: int) -> dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Schedule insights generation failed: {str(e)}"}
