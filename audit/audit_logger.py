...
class AuditLogger:
    ...
    def log_action(
        ...
        try:
            ...
            try:
                ...
                # The session is already broken; nothing useful to do here.
                pass
    ...
    def log_integration_action(self, action, service_type, details=None):
        ...
        self.log_action(
            f"integration_{action}", resource_type="integration", details=integration_details
        )
    ...
    def get_resource_history(self, resource_type, resource_id, limit=50):
        ...
        try:
            ...
            return (
                AuditLog.query.filter_by(resource_type=resource_type, resource_id=resource_id)
                .order_by(AuditLog.timestamp.desc())
                .limit(limit)
                .all()
            )
